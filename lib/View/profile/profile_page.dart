...
/// Profile page - migrated from legacy profile.dart
/// Uses Navigator instead of GetX and ProfileCubit for state management
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void _copyToClipboard(BuildContext context, String text, Color color) {
        ...
        body: BlocBuilder<ProfileCubit, ProfileState>(
          builder: (context, state) {
            ...
            final totalPercentage =
                UserProfileEntity.getProgressTarget(profile.level);
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  IconButton(
                    onPressed: () =>
                        _showEditUsernameDialog(context, profile.username),
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  IconButton(
                    onPressed: () =>
                        _copyToClipboard(context, profile.id, progressColor),
