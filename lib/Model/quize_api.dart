...
class CheckAnswerPage extends StatefulWidget {
  CheckAnswerPage(
      {super.key, required this.userAnswer, required this.question});
  String userAnswer;
  String question;

  @override
  _CheckAnswerPageState createState() => _CheckAnswerPageState();
}
...
""";
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final RegExp regex = RegExp(r"\{score:\s*(\d+),\s*explanation:\s*(.*?)\}", dotAll: true);
